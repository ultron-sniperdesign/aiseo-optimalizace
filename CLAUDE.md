...
- **Anglicismy v UI řetězcích hlídá `blogger/JAZYK_SLOVNIK.md`** — slovník platí i pro `src/i18n/*`, ne jen pro články. Například „Klíčový insight" bylo v rozporu se zakázaným `\binsight\b` (náhrada: poznatky, zjištění) a 6. 9. 2026 přejmenováno na „Klíčové zjištění". Před přidáním nového mikrotextu ho projdi proti slovníku.
