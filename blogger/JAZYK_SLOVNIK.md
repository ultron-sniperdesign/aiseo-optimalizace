...
| ⚠️ | `\b(?:vyhledávací(?:ho|mu|m|mi|ch)? povrch(?:u|y|ů|em|ích|ům)?|povrch(?:u|y|ů|em|ích|ům)? (?:vyhledávání|Googlu|Google|ChatGPT|Perplexity|AI))\b` | prostředí, místo ve vyhledávání | možný kalk z „surface“ v digitálním kontextu; posoudit význam. Fyzický povrch materiálu je správné české slovo a samostatně se nehlásí | ai-mode-a-eshopy 2026-08-26; delka-obsahu-pro-ai 2026-09-17: čistič určený pro povrch není jazyková chyba |
