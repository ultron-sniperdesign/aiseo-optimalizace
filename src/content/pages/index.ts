...
export const offers = [
  ...
  },
  {
    ...
    tag: "Audit AI&nbsp;viditelnosti od&nbsp;Sniper Design",
    priceMain: "3&nbsp;600&nbsp;Kč",
    priceNote: "bez DPH &middot; jednorázově",
    priceVat: "4&nbsp;356&nbsp;Kč s&nbsp;DPH",
    title: "Přesný plán pro váš konkrétní web",
    desc: "Důkladná analýza vašeho webu od&nbsp;Sniper Design týmu. Prioritní seznam úprav s&nbsp;odhadem dopadu + meeting 30&ndash;60 minut nad výsledky.",
    bullets: [
      "Viditelnost v&nbsp;AI, technika, obsah a&nbsp;důvěryhodnost",
      "Prioritní seznam úprav s&nbsp;odhadem dopadu",
      "Výstup do&nbsp;5 pracovních dní od&nbsp;úhrady",
      "Meeting 30&ndash;60 minut s&nbsp;naším týmem",
    ],
    cta: "Objednat audit",
  },
];
