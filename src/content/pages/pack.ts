...
export const faq: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Pack obsahuje krok-za-krokem návod psaný pro provozovatele webů, ne pro vývojáře. Většinu úprav (text, struktura) zvládnete sami za odpoledne. Strukturovaná data připravíte jako podklad a předáte vývojáři nebo správci webu. Pokud preferujete, abychom to udělali za vás, podívejte se na Audit AI viditelnosti od Sniper Design za 3 600 Kč — projdeme váš web a předáme prioritní seznam úprav.",
  },
  {
