...
[První díl](/blog/shoptet-strukturovana-data-mereni/) skončil otevřenou otázkou: robots.txt byl u všech patnácti měřených e-shopů identický, ale jestli ho jde v administraci upravit, jsem netvrdil ani jedním směrem.
