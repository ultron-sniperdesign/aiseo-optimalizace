...
<MistakeGrid>
  <Mistake num="01" title="Browser extensions na blokování AIO" fix="Použijte transparentnější web filter udm=14 — bez nutnosti oprávnění v prohlížeči navíc.">
  ...
  <Mistake num="02" title="Hosts file modifikace" fix="Nikdy neblokujte gemini.google.com přes hosts — rozbijete celé Google, ne jen AIO.">
    Staré rady doporučují blokovat `gemini.google.com`. Tím rozbijete celé Google features, ne jen AIO. Vedlejší dopady jsou nepředvídatelné.
  </Mistake>
  <Mistake num="03" title="Hledat globální vypínač AI Off" fix="Neexistuje. Search Labs experiment je nejblíž — a ani ten není garantovaný.">
    Ve Google Settings žádný globální vypínač AI Overviews není. Hledání master switche je ztráta času.
  </Mistake>
  <Mistake num="04" title="Žádost o vypnutí na Google supportu" fix="Account-specific vypnutí Google nedává — řešte přes web filter nebo jiný vyhledávač.">
...
<Stepper tone="aio" steps={[
  { title: "Vybrat cluster URL", desc: "Typicky 10–30 informačních non-brand stránek se srovnatelným typem dotazu (how-to průvodce, definiční články, srovnání). Nemíchat s brand a transakčními URL." },
  { title: "Vyfiltrovat dotazy v GSC", desc: "Performance → Queries, filtr brand vs non-brand. Pokles CTR u non-brand informačních dotazů se stabilními nebo rostoucími impressions = indikátor." },
  { title: "Baseline metriky", desc: "Clicks, impressions, avg position a CTR za 4–8 týdnů před testem — zachytí sezónnost." },
  { title: "Nasadit jen na segment", desc: "data-nosnippet na úvodní answer block 5–10 vybraných URL, ne plošně. Sledovat 30–60 dní." },
  { title: "Vyhodnotit po týdnech", desc: "Porovnání baseline vs po-test, kontrola brand query mixu (brand snippet je často výhoda, ne ztráta), vyhodnotit, jestli se pokles CTR zlepšil bez vedlejších škod." }
]} />

<AntiPersona title="Co NEDĚLAT jako publisher">
...
<PersonaGrid>
  <Persona icon="🔍" title="Uživatel: Google bez AIO" tone="aio">
    Chcete dál používat Google, jen bez panelu. Cesta: Search Labs experiment + `&udm=14` web filter jako default vyhledávač.
  </Persona>
  ...
  <Persona icon="📊" title="SEO / content tým" tone="aio">
    Řešíte pokles CTR po nástupu AIO. Snippet direktivy selektivně + GSC query-level audit (brand vs non-brand).
  </Persona>
  <Persona icon="📰" title="Publisher / magazín / obsahový web" tone="aio">
    Mini-metodika výše + segmentace brand/non-brand. Obranná snippet politika podle typu obsahu, ne plošně.
  </Persona>
  <Persona icon="🛒" title="E-commerce a leadgen" tone="aio">
...
Tento web provozuje agentura **[Sniper Design](https://www.sniperdesign.cz/)** — pokud řešíte AIO jako business problém, ne jen jako uživatelské nastavení, [nabízíme 3 typy auditu](https://www.sniperdesign.cz/audity):
