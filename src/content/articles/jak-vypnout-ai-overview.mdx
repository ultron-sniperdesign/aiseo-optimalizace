...
**Korelace mezi AIO a poklesem návštěvnosti není automaticky kauzalita.** Rozhodnutí o snippet restrikcích by mělo vycházet z dat v GSC na úrovni dotazů a typů landing pages, ne z agregovaných odhadů třetích stran.
