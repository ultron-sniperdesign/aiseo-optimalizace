...
3. **Plošná `nosnippet`** — ztratíte i pozitivní snippet trafic
4. **Ignorování typu businessu** — B2C e-shop nemá co dělat v plné GEO investici
5. **Žádný iterativní review** — strategie se mění s rostoucím obsahem (review každé 3 měsíce)
