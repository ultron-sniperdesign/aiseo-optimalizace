...
<Insight tone="seo" icon="!" label="Pravidlo č. 1">
  **Bez kvalitního SEO základu žádná z AI disciplín nezafunguje.** Google a AI engines indexují stejný web; pokud vás Google nevidí, ChatGPT vás nezacituje a v AI Overview se neobjevíte.
</Insight>
