...
## SEO nástroje — krátký přehled

Nástroje pro SEO se v roce 2026 dělí do tří vrstev: **free baseline od vyhledávačů** (GSC, Bing Webmaster, Seznam Webmaster — vlastní data, jediný 100% spolehlivý zdroj), **placené konkurenční a keyword research nástroje** (Ahrefs, Semrush, SE Ranking, Marketing Miner) a nově i **AI citation tracking** (Otterly, Profound) pro sledování mentions v ChatGPT, Perplexity a Claude. Reálné ceny i doporučené stacky podle velikosti projektu se v posledních dvou letech výrazně proměnily.

<Insight tone="seo" icon="→" label="Samostatný průvodce">
  Kompletní průvodce SEO nástroji 2026 (7 kategorií, reálné ceny, 4 doporučené stacky podle situace — od malé firmy po enterprise) má vlastní článek: **[SEO nástroje 2026: kompletní průvodce kategoriemi, cenami a AI érou](/seo-nastroje-2026/)**.
</Insight>
