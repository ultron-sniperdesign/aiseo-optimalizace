...
<ToolGrid tone="seo" items={[
  ...
  { name: "Ahrefs / Semrush / SE Ranking", tier: "paid", category: "Konkurenti", desc: "Backlink profil konkurence, gap analýza, share of voice, content audit." },
  { name: "Marketing Miner", tier: "paid", category: "Keyword research", desc: "CZ-first hledanost, sezónnost, intent, difficulty. Pro CZ trh nejdostupnější." },
  { name: "Google Keyword Planner", tier: "free", category: "Keyword research", desc: "Hledanost a CPC odhady přímo z Google Ads — orientačně i pro organic." },
  { name: "Screaming Frog", tier: "both", category: "Technický audit", desc: "Crawl chyby, struktura URL, schema validace. Free do 500 URL." },
  { name: "PageSpeed Insights", tier: "free", category: "Core Web Vitals", desc: "LCP, INP, CLS měření na lab i field datech (Chrome UX Report).", url: "https://pagespeed.web.dev/" },
  { name: "Google Rich Results Test", tier: "free", category: "Schema validace", desc: "Validace JSON-LD strukturovaných dat. Co Google reálně rozpozná jako rich result.", url: "https://search.google.com/test/rich-results" },
  { name: "Otterly / Profound", tier: "paid", category: "AI éra", desc: "Citation share v ChatGPT, Perplexity, Claude. Mention monitoring a brand visibility v AI." }
]} />

<Insight tone="seo" icon="✦" label="Doporučený stack">
  **Pro malou firmu stačí: GSC + PageSpeed Insights + Rich Results Test + jeden placený nástroj na konkurenci** (Ahrefs nebo SE Ranking, ~5 000 Kč/měs.). Většinu věcí, které dělá agentura ručně v dražších stack-ách, malá firma nezvládne ani s nejdražším nástrojem — value je v interpretaci, ne v datech.
</Insight>
...
<Insight tone="seo" icon="P" label="Výstup auditu">
  **Seznam priorit (P0/P1/P2) s odhadem dopadu a effort.** Realisticky se v jednom auditu dostanete na 30–80 nálezů; dělejte top 10 každý měsíc, audit refreshujte za rok.
</Insight>
