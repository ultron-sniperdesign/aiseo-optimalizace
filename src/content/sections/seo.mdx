...
SEO audit je strukturovaná **diagnostika webu ve třech vrstvách** — technická, on‑page, off‑page — s pořadím, kde chyby v nižší vrstvě negují optimalizace na vyšší. Výstupem je seznam nálezů s prioritou (P0/P1/P2). Audit dává smysl udělat 1× ročně nebo po major redesignu.

<Insight tone="seo" icon="→" label="Samostatný průvodce">
  Kompletní checklist auditu (3 vrstvy, jak prioritizovat, kdy svépomocí a kdy s agenturou) má vlastní článek: **[SEO audit — co kontrolovat 1× ročně](/seo-audit-co-kontrolovat/)**.
</Insight>
