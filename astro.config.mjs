...
export default defineConfig({
  ...
  integrations: [
    ...
    // IndexNow už není integrace Astra. Detekce změn se neopírá o hash
    // zbuildovaného HTML (nefungovalo — viz hlavička scripts/indexnow.mjs),
    // ale o git diff v samostatném kroku CI po deploji. Podání je do vyřešení
    // tiketu u Bingu (403, UCM000007490076) vypnuté.
  ],
  vite: {
